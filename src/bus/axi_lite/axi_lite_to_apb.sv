...
module axi_lite_to_apb #(
  parameter int unsigned NoApbSlaves = 32'd4,  // Number of connected APB slaves (Updated to 4)
  parameter int unsigned NoRules     = 32'd4,  // Number of APB address rules (Updated to 4)
...
module axi_lite_to_apb_intf #(
  ...
  input  logic  [NoApbSlaves-1:0] pslverr_i, // Added explicit 'logic' keyword for syntax safety
  // APB Slave Address Map
  input  rule_t [NoRules-1:0]      addr_map_i
);
