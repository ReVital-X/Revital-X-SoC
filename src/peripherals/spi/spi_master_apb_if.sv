...
(
    ...
    assign spi_int_rd_sta = read_enable & (PADDR == REG_INTSTA);
  ...
  always_comb
    ...
    assign spi_data_tx_valid = write_enable & (PADDR == REG_TXFIFO);
    assign spi_data_rx_ready = read_enable & (PADDR == REG_RXFIFO);
