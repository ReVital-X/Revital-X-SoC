    ...
    begin
        ...
        case(CS)
            ...
            begin
                ...
                case(cfg_bits_i)
                    2'b00:
                        reg_data_next = {3'b000,reg_rx_sync[2],reg_data[4:1]}; //4 bits
                    2'b01:
                        reg_data_next = {2'b00,reg_rx_sync[2],reg_data[5:1]}; //6 bits
                    2'b10:
                        reg_data_next = {1'b0,reg_rx_sync[2],reg_data[6:1]}; // 7 bits
                    2'b11:
                        reg_data_next = {reg_rx_sync[2],reg_data[7:1]}; //8 bits received
                endcase
