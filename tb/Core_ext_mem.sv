...
//dut.s1.instr_mem.ram3.mem[2] = 32'h0000A103; // lw x2, 0(x1)
  ...
  dut.core1.s1.instr_mem.ram1.mem[2] = 32'h0000A103; // lw x2, 0(x1)
...
//dut.s1.instr_mem.ram1.mem[5] = 32'h00000013; // nop
  ...
  dut.core1.s1.rf.regfile[1]  = 32'h00000200;
  dut.core1.s1.rf.regfile[2]  = 2;

  dut.core1.s1.rf.regfile[3]  = 3;
...
$display("sram_ext [0]=%0d", dut.ext_mem.mem[0]);
